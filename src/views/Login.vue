  ...
  <div class="min-h-screen wave-background flex items-center justify-center">
    ...
    <div class="w-full max-w-md px-6 relative z-10">
      ...
      <div class="bg-slate-800 rounded-2xl shadow-2xl p-8 border border-slate-700">
          ...
          <div>
            ...
            <div class="relative">
              <input v-model="password" :type="showPassword ? 'text' : 'password'"
                ...
                placeholder="请输入密码" />
              <button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-white"
        ...
        <!-- GitHub 登录 -->
        <a href="https://zlawrance.online/api/auth/oauth/github/authorize"
